...
export function SequencesView({ problem, onSubmit, level }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Suite logique</Text>
      ...
      <View style={styles.keypad}>
        ...
        <TouchableOpacity style={styles.keypadButton} onPress={handleNegative}>
      ...
      <Text style={styles.hint}>Trouvez le prochain terme de la suite</Text>
    </View>
  );
}
